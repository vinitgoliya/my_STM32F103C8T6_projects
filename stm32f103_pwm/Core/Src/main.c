...
/* Definitions for controle_task */
osThreadId_t controle_taskHandle;
const osThreadAttr_t controle_task_attributes = {
  .name = "controle_task",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
int main(void)
{
  ...
  */
  ...
  /* creation of controle_task */
  controle_taskHandle = osThreadNew(StartTask02, NULL, &controle_task_attributes);
